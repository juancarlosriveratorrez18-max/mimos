...
// Rutas privadas 
// POST - Crear helado
router.post('/helados', verificarToken, verificarAdmin,upload.single('imagen'), crear);

// PUT - Actualizar helado
router.put('/helados/:id', verificarToken, verificarAdmin, upload.single('imagen'), editar);
